...
import irdp.protocols.tutorialDA.Atividade1.JobApplicationLayer;
import irdp.protocols.tutorialDA.Atividade1.JobLayer;
import irdp.protocols.tutorialDA.Atividade1.JobTransformationLayer;
...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    Layer[] qos = {new JobLayer(), new JobTransformationLayer(),
        new JobApplicationLayer()};
